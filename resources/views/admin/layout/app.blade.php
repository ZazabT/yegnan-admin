                  ...
                  <li  class="has-sub" >
                    ...
                    <ul  class="collapse"  id="email"
                      ...
                      <div class="sub-menu">
                            ...
                            <li >
                              <a class="sidenav-item-link" href="{{route('hosts')}}">
                  ...
                  <li class="dropdown user-menu">
                    ...
                    <ul class="dropdown-menu dropdown-menu-right">
                      ...
                      <li class="dropdown-footer">
                        ...
                        <a class="dropdown-link-item" href="#" onclick="event.preventDefault(); document.getElementById('logout-form').submit();"> <i class="mdi mdi-logout"></i> Log Out </a>
                      </li>
                    </ul>
                  </li>
                </ul>
